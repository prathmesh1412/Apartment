          ...
          <table className="w-full text-left border-collapse text-[10.5px]">
            ...
            <tbody className="divide-y divide-slate-100 font-medium text-slate-700">
              <tr>
                ...
                <td className="py-2 px-4 text-slate-505">Prior approval + gender certificate</td>
                ...
                <td className="py-2 px-4 text-slate-505">Ongoing (annual renewal)</td>
              ...
              <tr className="bg-slate-50/30">
                ...
                <td className="py-2 px-4 text-center"><span className="bg-[#f0fdf4] text-green-700 text-[8.5px] font-black px-2 py-0.5 rounded">Unit</span></td>
                <td className="py-2 px-4 text-slate-550">Prior approval + disability certificate</td>
                <td className="py-2 px-4">50% off</td>
                <td className="py-2 px-4 font-black text-blue-600">All</td>
                <td className="py-2 px-4 text-center">50%</td>
                <td className="py-2 px-4 text-slate-550">Ongoing</td>
              ...
              <tr>
                ...
                <td className="py-2 px-4 text-center"><span className="bg-[#f0fdf4] text-green-700 text-[8.5px] font-black px-2 py-0.5 rounded">Unit</span></td>
                <td className="py-2 px-4 text-slate-550">Auto-verified from payment gateway</td>
                <td className="py-2 px-4">5% off</td>
                <td className="py-2 px-4 font-black text-blue-600">All</td>
                <td className="py-2 px-4 text-center">5%</td>
                <td className="py-2 px-4 text-slate-550">Per transaction</td>
              ...
              <tr className="bg-slate-50/30">
                ...
                <td className="py-2 px-4 text-slate-550">Building green rating certificate</td>
                <td className="py-2 px-4">8% off</td>
                <td className="py-2 px-4 font-black text-blue-600">All</td>
                <td className="py-2 px-4 text-center text-green-600 font-bold">8%</td>
                <td className="py-2 px-4 text-slate-550">3 years from certification</td>
              ...
              <tr>
                ...
                <td className="py-2 px-4 text-center"><span className="bg-[#f0fdf4] text-green-700 text-[8.5px] font-black px-2 py-0.5 rounded">Unit</span></td>
                <td className="py-2 px-4 text-slate-550">Auto-verified — full dues cleared</td>
                <td className="py-2 px-4">5% off</td>
                <td className="py-2 px-4 font-black text-blue-600">All</td>
                <td className="py-2 px-4 text-center text-green-600 font-bold">5%</td>
                <td className="py-2 px-4 text-slate-550">Per assessment year</td>
              ...
              <tr className="bg-slate-50/30">
                ...
                <td className="py-2 px-4 text-slate-550">Prior approval + waste audit report</td>
                <td className="py-2 px-4">7% off</td>
                <td className="py-2 px-4 font-black text-blue-600">All</td>
                <td className="py-2 px-4 text-center">7%</td>
                <td className="py-2 px-4 text-slate-550">Annual (audit required)</td>
              ...
              <tr>
                ...
                <td className="py-2 px-4 text-center"><span className="bg-purple-100 text-purple-700 text-[8.5px] font-black px-2 py-0.5 rounded">Wing</span></td>
                <td className="py-2 px-4 text-slate-550">RWH inspection certificate</td>
                <td className="py-2 px-4">5% off</td>
                <td className="py-2 px-4 font-black text-slate-650">Residential</td>
                <td className="py-2 px-4 text-center text-green-600 font-bold">5%</td>
                <td className="py-2 px-4 text-slate-550">1 year from certification</td>
              ...
              <tr className="bg-slate-50/30">
                ...
                <td className="py-2 px-4 text-center"><span className="bg-purple-100 text-purple-700 text-[8.5px] font-black px-2 py-0.5 rounded">Wing</span></td>
                <td className="py-2 px-4 text-slate-550">Solar commission certificate</td>
                <td className="py-2 px-4">₹3,000 flat</td>
                <td className="py-2 px-4 font-black text-blue-600">All</td>
                <td className="py-2 px-4 text-center text-green-600 font-bold">₹3,000</td>
                <td className="py-2 px-4 text-slate-550">First 3 years</td>
