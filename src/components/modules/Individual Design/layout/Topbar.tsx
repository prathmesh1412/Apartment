...
import { RedBellDropdown, GreenBellDropdown, ProfileDropdown, SearchFilterDropdown } from '@/components/modules/Individual Design/layout/TopbarDropdowns';
          ...
          <div className="flex-grow lg:flex-grow-0 max-w-md lg:max-w-[380px] xl:max-w-[480px] flex items-center gap-2 relative">
            ...
            <div className="relative">
              <button
                ...
                aria-haspopup="true"
                className={`p-1.5 border rounded-md flex items-center justify-center cursor-pointer shrink-0 shadow-sm w-8 h-8 transition-all relative ${isFilterOpen || appliedFiltersCount > 0
              ...
              {activeDropdown === 'access' && (
                <div className="absolute right-0 top-full mt-1.5 w-44 bg-[#1e2b58] border border-white/15 rounded-lg shadow-xl py-1 z-55 animate-fadeIn">
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 text-[10.5px] font-semibold transition-colors flex items-center gap-1.5 cursor-pointer ${role === 'surveyor' ? 'bg-[#2563eb] text-white' : 'text-gray-200 hover:bg-white/5'
                      }`}
                  >
                    Surveyor View
                  </button>
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 text-[10.5px] font-semibold transition-colors flex items-center gap-1.5 cursor-pointer ${role === 'qc' ? 'bg-[#2563eb] text-white' : 'text-gray-200 hover:bg-white/5'
                      }`}
                  >
                    QC Auditor View
                  </button>
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 text-[10.5px] font-semibold transition-colors flex items-center gap-1.5 cursor-pointer ${role === 'final' ? 'bg-[#2563eb] text-white' : 'text-gray-200 hover:bg-white/5'
                      }`}
                  >
                    Final Approver
                  </button>
