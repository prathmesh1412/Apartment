      ...
      <div className="flex-grow flex-1 min-h-0 overflow-hidden flex gap-4">
        <div className="w-[200px] shrink-0 overflow-y-auto pr-1.5 flex flex-col gap-3 text-[10px] font-black text-slate-800 uppercase tracking-wider select-none no-scrollbar">
          <Select
            ...
            onChange={(e, val) => setFormData(prev => ({ ...prev, noticeType: val }))}
            options={[
              { label: 'Tax Demand Notice (Form-G)', value: 'Tax Demand Notice (Form-G)' },
              { label: 'Arrears Demarcation Warning', value: 'Arrears Demarcation Warning' },
              { label: 'Mutation Registry Clearance', value: 'Mutation Registry Clearance' },
            ]}
            selectSize="sm"
            className="text-[9.5px] font-extrabold text-slate-900 bg-white"
          />
          <Select
            label="Language"
            value={formData.noticeLang}
            onChange={(e, val) => setFormData(prev => ({ ...prev, noticeLang: val }))}
            options={[
          ...
          <Input
            ...
            className="h-8 p-1.5 text-[9.5px] font-extrabold text-slate-900 bg-white border-gray-300"
          />
          <Input
            label="Due Date"
          ...
          <Input
            ...
            className="h-8 p-1.5 text-[9.5px] font-extrabold text-slate-900 bg-white border-gray-300 tabular-nums"
          />
        </div>
